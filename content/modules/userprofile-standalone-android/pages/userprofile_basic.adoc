...
* We create an instance of the `DatabaseConfiguration` within link:{githubsrc}/app/src/main/java/com/couchbase/userprofile/util/DatabaseManager.java[*DatabaseManager.java*] via an `abstract` requirement from the parent class, `BaseRepository`.
